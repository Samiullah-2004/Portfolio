        ...
        <div ref={contentRef} className="max-w-4xl mx-auto !px-6 md:!px-12 !pb-0">
          ...
          <div className="flex flex-col !mt-24 md:!mt-36 reveal">
            <div className="flex items-center gap-x-4">
              ...
              <a href="https://samiullah-2004.github.io/Skycast-Weather-App/" target="_blank" rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 !mt-10 reveal">
            {[
              ...
              { label: 'Stack', value: 'JavaScript · CSS · Open-Meteo API' },
          ...
          <div className="!mt-12 reveal">
            ...
            <div className="flex flex-col gap-y-0">
              {[
                { icon: '🌍', title: 'Global City Search', desc: 'Search any city worldwide and instantly get live weather conditions.' },
                { icon: '⚡', title: 'Real-Time Atmospheric Data', desc: 'Temperature, humidity, wind speed, and conditions powered by Open-Meteo API.' },
                { icon: '🎨', title: 'Minimal UI Design', desc: 'Clean, distraction-free interface built with pure CSS — fast and lightweight.' },
              ].map((f) => (
